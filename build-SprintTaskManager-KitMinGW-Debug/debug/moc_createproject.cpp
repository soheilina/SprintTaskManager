...
#include "../../SprintTaskManager/createproject.h"
...
static const char qt_meta_stringdata_CreateProject[] = {
    "CreateProject\0\0on_textEdit_destroyed()\0"
};
...
void CreateProject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_textEdit_destroyed(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData CreateProject::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CreateProject::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CreateProject,
      qt_meta_data_CreateProject, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CreateProject::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CreateProject))
